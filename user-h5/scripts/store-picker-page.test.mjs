...
if (!menuJs.includes('resolveStoreCatalog') || !menuJs.includes('selectStore') || !menuJs.includes('useDeviceLocation')) {
...
globalThis.wx = {
  ...
  openLocation() {},
  switchTab() {},
  navigateTo({ url }) { lastNavigatedTo = url },
  navigateBack() {}
}
globalThis.getApp = () => ({
  globalData: {
...
menuPage.handleSelectPickerStore({ currentTarget: { dataset: { id: 'store-002' } } })
