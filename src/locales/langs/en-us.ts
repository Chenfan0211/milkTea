const local: App.I18n.Schema = {
  ...
  route: {
    ...
    'review_role-detail': 'Role Review Detail',
    'trade_order-detail': 'Order Detail',
    'trade_verify-detail': 'Verification Detail',
    'finance_snapshot-detail': 'Snapshot Detail'
  },
  page: {
    login: {
      common: {
