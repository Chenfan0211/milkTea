...
export const adminRouteMeta: Record<string, AdminRouteMeta> = {
  ...
  marketing_points: { title: '积分商城', order: 4, roles: op, featureFlag: 'ENABLE_STORED_VALUE', keepAlive: true },
  marketing_member: { title: '会员等级', order: 5, roles: op, featureFlag: 'ENABLE_STORED_VALUE', keepAlive: true },
  marketing_comment: { title: '评论审核', order: 6, roles: op, featureFlag: 'ENABLE_REVIEW', keepAlive: true },
  'marketing_gift-order': { title: '礼品卡订单', order: 7, roles: op, featureFlag: 'ENABLE_STORED_VALUE', keepAlive: true },
  marketing_exchange: { title: '兑换记录', order: 8, roles: op, featureFlag: 'ENABLE_STORED_VALUE', keepAlive: true },
  marketing_referral: { title: '分享有礼', order: 9, roles: op, keepAlive: true },
